        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-32">
          ...
          <div className="footer-reveal lg:col-span-1">
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-xs font-light">
              Engineering the future of maritime infrastructure. Precision in execution, power in performance.
            </p>
          </div>
          ...
          <div className="footer-reveal">
            ...
            <ul className="space-y-4">
              {['Home', 'About', 'Fleet', 'Projects', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                  ...
                  >
                    <span className="w-0 h-[1px] bg-[#0ea5a4] group-hover:w-4 transition-all duration-300"></span>
                    {item}
                  </a>
                </li>
              ))}
          ...
          {/* Contact Info */}
          <div className="footer-reveal">
            <h4 className="text-[10px] uppercase tracking-[0.4em] text-[#0ea5a4] font-bold mb-10">Global Office</h4>
            <div className="space-y-6 text-sm">
              <p className="text-white/60 leading-relaxed font-light">
                Meka Towers, Coastal Road,<br />
                Marine Drive, Mumbai - 400021<br />
                Maharashtra, India
              </p>
              <div className="space-y-2">
                <p className="text-white hover:text-[#0ea5a4] transition-colors flex items-center gap-2">
                  <span className="text-[#0ea5a4]">E:</span> info@mekagroup.com
                </p>
                <p className="text-white flex items-center gap-2">
                  <span className="text-[#0ea5a4]">P:</span> +91 (022) 2345 6789
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="footer-reveal border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex gap-6">
              <a href="#" className="text-[10px] uppercase tracking-[0.2em] text-white/20 hover:text-white transition-colors">Privacy</a>
