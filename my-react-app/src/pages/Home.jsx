      ...
      gsap.to("#global-scroll-btn", {
        ...
        x: () =>
          window.innerWidth >= 768
            ? -48
            : -32, // 48px margin desktop, 32px mobile
        y: () =>
          window.innerWidth >= 768
            ? -48
            : -32,
      ...
      const sections = [
        {
          id: "#hero",
          next: "#about",
          nextText: "Scroll to About",
          prev: "#hero",
          prevText: "Scroll to explore",
        },
        {
          id: "#about",
          next: "#projects",
          nextText:
            "Scroll to Projects",
          prev: "#hero",
          prevText: "Scroll to Hero",
        },
        {
          id: "#projects",
          next: "#archive",
          nextText: "Scroll to Archive",
          prev: "#about",
          prevText: "Scroll to About",
        },
        {
          id: "#archive",
          next: "#hero",
          nextText: "Back to Top",
          prev: "#projects",
          prevText:
            "Scroll to Projects",
        },
